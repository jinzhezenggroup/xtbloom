...
geometry, and tblite-derived LiH/SiH4 GFN1 D3 energies and gradients with the
corresponding geometries. They also retain MB16-43 structure 01 coordinates from mstore v0.3.0
revision `663245d739be0123da61c917e55116b0c3db4c74` (`Apache-2.0`) and the
corresponding GFN1 effective-repulsion energy from tblite inspection revision
`133f91efb94b47f05848e1f86832f40a1accc385` (`LGPL-3.0-or-later`). Exact
