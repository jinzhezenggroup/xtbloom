#ifndef XTBLOOM_MODEL_GFN1_WAVEFUNCTION_HPP
// xtbloom's CUDA/MKL additional permission is in CUDA_MKL_LINKING_EXCEPTION.

#define XTBLOOM_MODEL_GFN1_WAVEFUNCTION_HPP
...
struct WavefunctionWarmStartIdentity {
  xtbloom_model_t model = XTBLOOM_MODEL_GFN1_XTB;
...
/*
 * Geometry-independent, backend-neutral layout for a ragged GFN1 batch.
 *
 ...
 * alpha/beta channels when nspin is two. The SCC qsh and qat fields use
 * tblite's charge/magnetization representation with shapes [nspin, nsh] and
 * [nspin, nat]. GFN1 is scalar: atomic dipole and quadrupole storage is
 * intentionally absent from this layout.
 *
...
/*
 * Initialize tblite-compatible superposition-of-atomic-densities scalar state
 * without allocating. Charge is distributed uniformly over atoms in channel
 * zero and then partitioned over shells according to n0sh/n0at.
 * The optional magnetization channel is zeroed.
...
#endif  // XTBLOOM_MODEL_GFN1_WAVEFUNCTION_HPP
