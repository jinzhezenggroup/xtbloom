...
int test_all_elements_and_shell_angular_momenta() {
  std::vector<std::int32_t> atomic_numbers(xtbloom::parameters::gfn2::kElementCount);
  ...
  CHECK(plan.total_shells == static_cast<std::int64_t>(xtbloom::parameters::gfn2::kShellCount));
  CHECK(plan.batch_shell_offsets == basis.batch_shell_offsets);

  const ES3View view = xtbloom::detail::gfn2::make_es3_view(plan);
  ...
  for (std::size_t atom = 0; atom < atomic_numbers.size(); ++atom) {
    const auto& element = xtbloom::parameters::gfn2::kElements[atom];
    for (std::int64_t shell = basis.atom_shell_offsets[atom];
      ...
      const double expected =
          element.gam3 *
          xtbloom::parameters::gfn2::kGlobal.thirdorder_shell_scale[angular_momentum];
  ...
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_cpu(view, charges.data(), potentials.data(),
                                                          error) == XTBLOOM_STATUS_SUCCESS);
  ...
  CHECK(xtbloom::detail::gfn2::add_es3_energy_cpu(view, charges.data(), energies.data(), error) ==
        XTBLOOM_STATUS_SUCCESS);
...
double total_energy(ES3View view, const std::vector<double>& charges, std::string& error) {
  ...
  if (xtbloom::detail::gfn2::add_es3_energy_cpu(view, charges.data(), energies.data(), error) !=
      XTBLOOM_STATUS_SUCCESS) {
...
int test_ragged_sequential_and_energy_potential_derivative() {
  ...
  for (std::int64_t system = 0; system < view.batch_size; ++system) {
    ...
    CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(
              view, system, charges.data(), system_energy, error) == XTBLOOM_STATUS_SUCCESS);
  ...
  for (std::size_t batch : {0u, 2u, 3u}) {
    ...
    const ES3View sequential_view = xtbloom::detail::gfn2::make_es3_view(sequential_plan);
    CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_cpu(
          ...
          XTBLOOM_STATUS_SUCCESS);
    CHECK(xtbloom::detail::gfn2::add_es3_energy_cpu(sequential_view, sequential_charges.data(),
...
int test_system_energy_failure_isolation_and_binding() {
  ...
  ES3View view = xtbloom::detail::gfn2::make_es3_view(plan);
  std::vector<double> charges(static_cast<std::size_t>(plan.total_shells));
  for (std::size_t shell = 0; shell < charges.size(); ++shell) {
  ...
  CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(view, target, charges.data(), expected,
                                                         error) == XTBLOOM_STATUS_SUCCESS);
  ...
  CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(view, target, charges.data(), isolated,
                                                         error) == XTBLOOM_STATUS_SUCCESS);
  ...
  isolated = 0.625;
  CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(
            poisoned_peer_view, target, charges.data(), isolated, error) == XTBLOOM_STATUS_SUCCESS);
  CHECK(isolated == expected);
  ...
  CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(view, target, charges.data(), unchanged,
  ...
  unchanged = -4.25;
  CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(poisoned_target_view, target,
  ...
  unchanged = 2.75;
  CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(view, -1, charges.data(), unchanged,
                                                         error) == XTBLOOM_STATUS_INVALID_ARGUMENT);
  CHECK(unchanged == 2.75);
  CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(view, view.batch_size, charges.data(),
                                                         unchanged,
                                                         error) == XTBLOOM_STATUS_INVALID_ARGUMENT);
  CHECK(unchanged == 2.75);
  ...
  CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(
            bad_view, target, charges.data(), unchanged, error) == XTBLOOM_STATUS_INVALID_ARGUMENT);
  CHECK(unchanged == 2.75);
  ...
  CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(view, target, charges.data(), charges[0],
                                                         error) == XTBLOOM_STATUS_INVALID_ARGUMENT);
  CHECK(charges == saved_charges);

  const std::vector<double> saved_gamma3 = plan.shell_gamma3;
  double& gamma_alias = plan.shell_gamma3[0];
  CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(view, target, charges.data(), gamma_alias,
                                                         error) == XTBLOOM_STATUS_INVALID_ARGUMENT);
  ...
  CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(view, target, charges.data(), offset_alias,
                                                         error) == XTBLOOM_STATUS_INVALID_ARGUMENT);
...
int test_system_potential_matches_batch_and_failure_isolation() {
  ...
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_cpu(
            view, charges.data(), batch_potentials.data(), error) == XTBLOOM_STATUS_SUCCESS);
  ...
  for (std::int64_t system = 0; system < plan.batch_size; ++system) {
    ...
    CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_system_cpu(
              view, system, charges.data(), system_potentials.data(), error) ==
          XTBLOOM_STATUS_SUCCESS);
  ...
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_system_cpu(view, target, charges.data(),
  ...
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_system_cpu(view, -1, charges.data(),
                                                                 system_potentials.data(), error) ==
  ...
  ES3View bad_view = view;
  --bad_view.shell_gamma3_count;
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_system_cpu(bad_view, target, charges.data(),
                                                                 system_potentials.data(), error) ==
        XTBLOOM_STATUS_INVALID_ARGUMENT);
  ...
  CHECK(charges == saved_charges);
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_system_cpu(
            view, target, charges.data(), nullptr, error) == XTBLOOM_STATUS_INVALID_ARGUMENT);
  ...
  const xtbloom_status_t status = xtbloom::detail::gfn2::evaluate_es3_potential_system_cpu(
...
int test_extreme_arithmetic() {
  ...
  charges[0] = 1.0e-200;
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_cpu(
            restored_view, charges.data(), potentials.data(), error) == XTBLOOM_STATUS_SUCCESS);
  ...
  charges[0] = 1.0e-110;
  energies[0] = 0.0;
  CHECK(xtbloom::detail::gfn2::add_es3_energy_cpu(restored_view, charges.data(), energies.data(),
                                                  error) == XTBLOOM_STATUS_SUCCESS);
  ...
  energies[0] = 0.75;
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_cpu(
            zero_view, charges.data(), potentials.data(), error) == XTBLOOM_STATUS_SUCCESS);
  CHECK(xtbloom::detail::gfn2::add_es3_energy_cpu(zero_view, charges.data(), energies.data(),
                                                  error) == XTBLOOM_STATUS_SUCCESS);
  CHECK(potentials[0] == 0.0);
...
int test_validation_and_failure_atomicity() {
  ...
  CHECK(xtbloom::detail::gfn2::make_es3_plan(basis, mismatched_numbers.data(), plan, error) ==
        XTBLOOM_STATUS_INVALID_ARGUMENT);
  ...
  CHECK(xtbloom::detail::gfn2::make_es3_plan(basis, nullptr, plan, error) ==
        XTBLOOM_STATUS_INVALID_ARGUMENT);

  BasisPlan corrupt_basis = basis;
  corrupt_basis.angular_momenta[0] = 3u;
  CHECK(xtbloom::detail::gfn2::make_es3_plan(corrupt_basis, atomic_numbers.data(), plan, error) ==
        XTBLOOM_STATUS_INVALID_ARGUMENT);
  corrupt_basis = basis;
  ...
  plan = saved_plan;
  const ES3View valid_view = xtbloom::detail::gfn2::make_es3_view(plan);
  ...
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_cpu(
            bad_view, charges.data(), potentials.data(), error) == XTBLOOM_STATUS_INVALID_ARGUMENT);
  ...
  bad_view = valid_view;
  bad_view.batch_shell_offsets = bad_offsets.data();
  CHECK(xtbloom::detail::gfn2::add_es3_energy_cpu(bad_view, charges.data(), energies.data(),
                                                  error) == XTBLOOM_STATUS_INVALID_ARGUMENT);
  ...
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_cpu(
            valid_view, nullptr, potentials.data(), error) == XTBLOOM_STATUS_INVALID_ARGUMENT);
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_cpu(
            valid_view, charges.data(), nullptr, error) == XTBLOOM_STATUS_INVALID_ARGUMENT);
  CHECK(xtbloom::detail::gfn2::add_es3_energy_cpu(valid_view, nullptr, energies.data(), error) ==
        XTBLOOM_STATUS_INVALID_ARGUMENT);
  CHECK(xtbloom::detail::gfn2::add_es3_energy_cpu(valid_view, charges.data(), nullptr, error) ==
        XTBLOOM_STATUS_INVALID_ARGUMENT);
  CHECK(potentials == saved_potentials && energies == saved_energies);

  charges.back() = std::numeric_limits<double>::infinity();
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_cpu(valid_view, charges.data(),
                                                          potentials.data(), error) ==
        XTBLOOM_STATUS_INVALID_ARGUMENT);
  CHECK(xtbloom::detail::gfn2::add_es3_energy_cpu(valid_view, charges.data(), energies.data(),
                                                  error) == XTBLOOM_STATUS_INVALID_ARGUMENT);
  CHECK(potentials == saved_potentials && energies == saved_energies);
  ...
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_cpu(valid_view, overlapping_charges.data(),
                                                          overlapping_charges.data(), error) ==
        XTBLOOM_STATUS_INVALID_ARGUMENT);
  CHECK(overlapping_charges == saved_overlapping_charges);
  CHECK(xtbloom::detail::gfn2::evaluate_es3_potential_cpu(valid_view, overlapping_charges.data(),
                                                          overlapping_charges.data() + 1, error) ==
        XTBLOOM_STATUS_INVALID_ARGUMENT);
  CHECK(overlapping_charges == saved_overlapping_charges);

  CHECK(xtbloom::detail::gfn2::add_es3_energy_cpu(valid_view, overlapping_charges.data(),
...
int test_zero_steady_state_allocations() {
  ...
  CHECK(xtbloom::detail::gfn2::add_es3_energy_cpu(view, charges.data(), energies.data(), error) ==
        XTBLOOM_STATUS_SUCCESS);
  double system_energy = 0.0;
  CHECK(xtbloom::detail::gfn2::add_es3_energy_system_cpu(view, 0, charges.data(), system_energy,
                                                         error) == XTBLOOM_STATUS_SUCCESS);
  energies.fill(0.0);
  allocation_test::count.store(0u, std::memory_order_relaxed);
  allocation_test::enabled.store(true, std::memory_order_relaxed);
  xtbloom_status_t potential_status = XTBLOOM_STATUS_INTERNAL_ERROR;
  xtbloom_status_t energy_status = XTBLOOM_STATUS_INTERNAL_ERROR;
  xtbloom_status_t system_energy_status = XTBLOOM_STATUS_INTERNAL_ERROR;
  for (int iteration = 0; iteration < 64; ++iteration) {
    potential_status = xtbloom::detail::gfn2::evaluate_es3_potential_cpu(view, charges.data(),
                                                                         potentials.data(), error);
    energy_status =
        xtbloom::detail::gfn2::add_es3_energy_cpu(view, charges.data(), energies.data(), error);
    system_energy_status = xtbloom::detail::gfn2::add_es3_energy_system_cpu(view, 0, charges.data(),
                                                                            system_energy, error);
  }
  allocation_test::enabled.store(false, std::memory_order_relaxed);
