...
int xtbloom_context_options_init(void *value, size_t size) { return init_full(value, size); }
...
int xtbloom_batch_result_init(void *value, size_t size) { return init_full(value, size); }
int xtbloom_workspace_query_init(void *value, size_t size) { return init_full(value, size); }
int xtbloom_result_owner_options_init(void *value, size_t size) { return init_full(value, size); }
...
int xtbloom_result_owner_export_dltensor(void *owner, void *view, int stream, void **managed) {
  (void)owner; (void)view; (void)stream; (void)managed;
  return 0;
}
int xtbloom_plan_create(void *context, const void *batch, const void *options, void **plan) {
  (void)context; (void)batch; (void)options;
  *plan = (void *)(uintptr_t)1u;
  return 0;
}
void xtbloom_plan_destroy(void *plan) { (void)plan; }
int xtbloom_plan_query_workspace(void *plan, void *query) { (void)plan; (void)query; return 0; }
int xtbloom_plan_compute(void *plan, const void *batch, const void *options, void *result) {
...
int xtbloom_compute(void *context, const void *batch, const void *options, void *result) {
